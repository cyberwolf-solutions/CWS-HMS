...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/restaurant/waiter', [RestaurantController::class, 'waiter'])->name('restaurant.waiter');
    ...
    Route::get('/super-admin/index', [SuperAdminController::class, 'index'])->name('super-index');
    Route::get('/super-admin/reindex', [SuperAdminController::class, 'returnToAdminPanel'])->name('super-reindex');
    // Route::get('/super-admin/login', [SuperAdminController::class, 'login'])->name('super-login');
    Route::get('/super-admin/branch', [SuperAdminController::class, 'branch'])->name('super-branch');
    // Route::get('/super-admin/user', [SuperAdminController::class, 'user'])->name('super-user');
    Route::post('/super-admin/branch/create', [BranchController::class, 'store'])->name('super-branchcreate');
    Route::get('/super-admin/user/create', [SuperAdminController::class, 'ucreate'])->name('super-ucreate');
    Route::post('/super-admin/user/userstore', [SuperAdminController::class, 'userstore'])->name('super-usertore');
    Route::post('/super-admin/user/rolestore', [SuperAdminController::class, 'rolestore'])->name('super.rolestore');
    Route::get('/super-admin/user1', [SuperAdminController::class, 'user1'])->name('super-user1');
    Route::get('/super-admin/role', [SuperAdminController::class, 'role'])->name('super-role');
    Route::get('/super-admin/role/create', [SuperAdminController::class, 'rcreate'])->name('super-rcreate');

    Route::get('/admin/impersonate/branch/{branchId}', [SuperAdminController::class, 'impersonateBranch'])->name('admin.impersonate.branch');

    Route::get('/admin/stop-impersonating', 'AdminController@stopImpersonating')->name('admin.stop.impersonating');

    Route::get('/admin/stop-impersonation', [SuperAdminController::class, 'stopImpersonating'])->name('admin.stopImpersonation');
