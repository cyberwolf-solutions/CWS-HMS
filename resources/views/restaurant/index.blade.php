                                ...
                                <div class="col-md-12 mt-2 mt-md-0">
                                    <div class="row">
                                        <div class="col-md-12 pe-2">
                                            <div class="d-flex flex-wrap overflow-auto gap-3 p-4 bg-light rounded-4 shadow-sm" 
                                                 style="max-height: 80vh; min-height: 80vh; background: #2b2b2b;">
                                                @foreach ($orders as $order)
                                                    <div class="meal-item1 shadow-sm rounded-3 cursor-pointer" 
                                                         data-id="{{ $order->id }}" 
                                                         data-category="{{ $order->category_id }}" 
                                                         data-price="{{ number_format($order->items->sum('total'), 2) }}" 
                                                         style="width: 24%; background: #2e2e2e; border: 1px solid #2b2b2b; padding: 15px; margin-bottom: 20px;">
                                                        
                                                        <div class="text-center">
                                                            <div class="order-header text-primary" style="font-weight: bold; font-size: 1.1em;">
                                                                Order ID: {{ $order->id }}
                                                            </div>
                                                            ...
                                                            <div class="order-details mt-3">
                                                                @foreach ($order->items as $item)
                                                                    <div class="d-flex justify-content-between align-items-center">
                                                                        <span class="meal-name" style="font-weight: 500;">{{ $item->meal->name }}</span>
                                                                        <span class="meal-price text-primary fw-bold">{{ $settings->currency }} {{ number_format($item->total, 2) }}</span>
                                                                    </div>
                                                                @endforeach
                                                            </div>
                                
                                                            <hr class="my-3" style="border-color: #ddd;">
                                                            
                                                            <div class="order-total d-flex justify-content-between align-items-center">
                                                                <strong>Total:</strong> 
                                                                <span class="text-primary fw-bold">{{ $settings->currency }} {{ number_format($order->items->sum('total'), 2) }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
            ...
            <div class="row position-relative   ">
                <div class="card  mb-1">
                    <div class="card-body ">
                        <div class="row gy-2">
                            <a href="{{ route('home') }}" type="button"
                                class="btn btn-light btn-icon waves-effect waves-light form-control"
                                data-bs-toggle="tooltip" title="Home"><i
                                    class="mdi mdi-home label-icon align-middle fs-16"></i></a>
                            <div class="col">
                                <button type="button"
                                    class="btn btn-soft-danger btn-label waves-effect waves-light form-control"
                                    onclick="window.location.reload()"><i
                            ...
                            <div class="col">
                                <button type="button"
                                    class="btn btn-light btn-label waves-effect waves-light form-control"
                                    data-ajax-popup="true" data-title="Notes" data-size="xl"
                                    data-url="{{ route('restaurant.note') }}"><i
                                        class="mdi mdi-book label-icon align-middle fs-16 me-2"></i>
                                    Notes</button>
                                ...
                                <div class="col-12 mt-1">
                                    ...
                                    <div class="col-12">
                                        <div class="row">
                                            ...
                                            <div class="col-4 p-2 border rounded-3 bg-blue-gray-100 small">
                                                <span>Discount (<span id="discount_method_html">0%</span>)</span><br>
                                                <span><span id="discount_html">LKR 0.00</span> <a
                                                        href="javascript:void(0)" class="float-end" id="discount-edit"
                                                        data-ajax-popup="true" data-title="Discount Edit" data-size="lg"
                                                        data-url="{{ route('restaurant.discount') }}">
                                                        (Edit)
                                                    </a></span>
                                            </div>
                                            ...
                                            <div class="col-12 rounded-3">
                                                <div class="row align-items-center p-2 ">
                                                    <button class="btn btn-primary text-dark fw-bold"
                                                        style="background-color: #378CE7;" onclick="waiter()">Add</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
@section('script')
    ...
    <script>
                                ...
                                <div class="col-md-7 mt-2 mt-md-0">
                                    <div class="row align-items-center">
                                        <div class="col-12 text-start">
                                            ...
                                            <h5 class="card-title" id="oid">${element.id}</h5>
        ...
        function loadCartCheckout() {
            ...
            // Check if the cart already has one item
            if (cart.length > 1) {
                display_error('Only one item allowed in the cart'); // Display an error message
                $('#loader').addClass('d-none');
                return; // Stop execution to prevent adding more items
            }else{
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.meal-item1', function() {
                $('#loader').removeClass('d-none');
    ...
    <script>
        function checkout() {
            ...
            var id = document.getElementById("oid").textContent;
