...
class ProductController extends Controller {
    ...
    public function index() {
        ...
        $data = Product::where('branch', $branch)->get();
    ...
    public function create() {
        ...
        // $data = Modifier::where('branch', $branch)->get();
        ...
        $is_edit = false;
        $ingredients = Ingredient::where('branch', $branch)->get();
        $categories = Category::where('branch', $branch)->get();
    ...
    public function getProducts(Request $request){
        ...
        $col .= '<td>' . $settings->currency . ' <span class="uprice">' . number_format($product->unit_price, 2) . '</span></td>';
